...
from text_to_speech.components import TEXT_FILE_NAME, CURRENT_TIME_STAMP
...
class TTSapplication:
    def __init__(self,app_config=TTSConfig()) ->None:
        ...
        try:
            ...
            self.audio_dir = app_config.text_dir
    ...
    def text2speech(self, text, accent):
        ...
        try:
            ...
            file_name = f"coverted_file{CURRENT_TIME_STAMP}.mp3"
